...
function [A1,A2,S_L] = GrowthAggregationBreakageNonDimensionalizedLengthBased(xi_alpha,w_alpha,G,a,beta,b_alpha,N_f)
    % number of weights
    n = length(w_alpha);
