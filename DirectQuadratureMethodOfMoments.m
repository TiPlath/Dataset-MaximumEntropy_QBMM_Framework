...
function [xi_alpha,w_alpha] = DirectQuadratureMethodOfMoments(xi_alpha,w_alpha,dt,G,a,beta,b_alpha)
    n = length(w_alpha);
    %% source term computation and timestepping
    % Select a suitable kernel
    [A1,A2,d_] = GrowthAggregationBreakage(xi_alpha,w_alpha,G,a,beta,b_alpha);
